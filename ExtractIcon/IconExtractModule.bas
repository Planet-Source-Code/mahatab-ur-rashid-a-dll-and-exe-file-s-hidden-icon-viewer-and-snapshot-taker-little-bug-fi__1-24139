...
Public Function ExtractIconAndShow(ByVal fileNameWithPath As String, IconNumber As Integer, Ctrl As Control)

Dim hIcon As Long  ' handle to the function gotten from the executable file
Dim retval As Long ' return value

hIcon = ExtractIcon(App.hInstance, fileNameWithPath, IconNumber)

If IconNumber = -1 Then
ExtractIconAndShow = hIcon  'Returning Total number of Icons
                            'in the file
Exit Function
End If

If hIcon = 0 Then
  ExtractIconAndShow = 1   'Unsuccessful operation
Else
  retval = DrawIcon(Ctrl.hdc, 0, 0, hIcon)
  retval = DestroyIcon(hIcon)
  ExtractIconAndShow = 0   'Successful operation
End If
End Function
